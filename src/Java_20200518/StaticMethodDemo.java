...
public class StaticMethodDemo {
	...
	public void m1() {
		...
		// instance 매서드에서는 instance 메서드, static 매서드 모두 호출 가능
		name = "chirsti"; // instance 변수 앞엔 this. 생략 => this.name / this 는 자기 자신 객체
		interestRate = 4.2;
		this.m2();
	...
	public void m2() {
		System.out.println("m2() 인스턴스매서드 호출");
	}
	...
	public static void m3() {
		...
		// static 매서드에서 instance 변수와 instance 메서드를 혼출하려면 객체를 먼저 생성해서 사용
